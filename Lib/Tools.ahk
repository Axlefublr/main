...
tool_CoordGetter() {
	...
	g_CrdGet_Screen     := g_CrdGet.Add("Text",, "Screen: ")
		...
		g_CrdGet_Screen_X := g_CrdGet.Add("Text", "x+", "x" ScrX " ")
			.OnEvent("Click", toClip.Bind(ScrX))
		g_CrdGet_Screen_Y := g_CrdGet.Add("Text", "x+", "y" ScrY " ")
			.OnEvent("Click", toClip.Bind(ScrY))
	g_CrdGet_Window     := g_CrdGet.Add("Text", "xm", "Window: ")
		.OnEvent("Click", toClip.Bind(WinX " " WinY))
		g_CrdGet_Window_X := g_CrdGet.Add("Text", "x+", "x" WinX " ")
			.OnEvent("Click", toClip.Bind(WinX))
		g_CrdGet_Window_Y := g_CrdGet.Add("Text", "x+", "y" WinY " ")
			.OnEvent("Click", toClip.Bind(WinY))
	g_CrdGet_Client     := g_CrdGet.Add("Text", "xm", "Client: ")
		.OnEvent("Click", toClip.Bind(CliX " " CliY))
		g_CrdGet_Client_X := g_CrdGet.Add("Text", "x+", "x" CliX " ")
			.OnEvent("Click", toClip.Bind(CliX))
		g_CrdGet_Client_Y := g_CrdGet.Add("Text", "x+", "y" CliY " ")
			.OnEvent("Click", toClip.Bind(CliY))
	g_CrdGet_Pixel      := g_CrdGet.Add("Text", "xm", "Pixel: " pixel)
		.OnEvent("Click", toClip.Bind(pixel))
	g_CrdGet_CtrlFormat := g_CrdGet.Add("Text", "xm", "CtrlClick Format")
